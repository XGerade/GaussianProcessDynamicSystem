...
plot(NULL, col = 'white', main = 'state of theta', xlim = c(0, timeLength * 0.02), ylim = c(-1, 1.5), xlab = 'time', ylab = 'theta')
...
plot(NULL, col = 'white', main = 'state of theta_1', xlim = c(0, timeLength * 0.02), ylim = c(-4, 4), xlab = 'time', ylab = 'theta')
...
plot(NULL, col = 'white', main = 'state of x', xlim = c(0, timeLength * 0.02), ylim = c(-1, 4), xlab = 'time', ylab = 'theta')
...
plot(NULL, col = 'white', main = 'state of theta', xlim = c(0, timeLength * 0.02), ylim = c(-3, 3), xlab = 'time', ylab = 'theta')

time <- seq(from = 0, to = timeLength * 0.02 - 0.02, by = 0.02)

points(time, statePH[, 4], col = 'blue', type = 'l')
points(time, stateCP[, 4], col = 'green', type = 'l')
